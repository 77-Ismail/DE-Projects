...
.json("/mnt/formula1dldbricksrg/raw/drivers.json")
...
drivers_final_df.write.mode("overwrite").parquet("/mnt/formula1dldbricksrg/processed/drivers")

# COMMAND ----------

display(spark.read.parquet("/mnt/formula1dldbricksrg/processed/drivers"))